  ...
  return (
    <View style={styles.container}>
      <View style={styles.enemyCard}>
        ...
        <ProgressBar progress={1} color={colors.danger} />
...
const styles = StyleSheet.create({
  ...
  enemyCard: { backgroundColor: colors.surface, borderRadius: 16, padding: 16, gap: 8 },
  stageLabel: { color: colors.textMuted, fontSize: 12, fontWeight: '700' },
  enemyName: { color: colors.text, fontSize: 22, fontWeight: '800' },
  subText: { color: colors.textMuted, fontSize: 12 },
  vsRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  powerText: { color: colors.text, fontSize: 12, flex: 1 },
  vsText: { color: colors.primary, fontWeight: '800', marginHorizontal: 8 },
  fightButton: {
